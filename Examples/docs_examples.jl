...
function draw_cooketriplet(filename::Union{Nothing,AbstractString}=nothing)
    g1, g2 = AGFFileReader.Examples_N_SK16, AGFFileReader.Examples_N_SF2
    sys = AxisymmetricOpticalSystem{Float64}(DataFrames.DataFrame(
        ...
        Material=[AGFFileReader.Air, g1, AGFFileReader.Air, g2, AGFFileReader.Air, g1, AGFFileReader.Air, missing],
...
function draw_zoomlenses(filenames::Vector{<:Union{Nothing,AbstractString}}=repeat([nothing], 3))
    ...
    syss = [
        AxisymmetricOpticalSystem{Float64}(DataFrames.DataFrame(
            ...
            Material=[AGFFileReader.Air, AGFFileReader.Air, OHARA.S_LAH66, AGFFileReader.Air, NIKON.LLF6, AGFFileReader.Air, OHARA.S_TIH6, OHARA.S_FSL5, AGFFileReader.Air, OHARA.S_FSL5, AGFFileReader.Air, OHARA.S_LAL8, OHARA.S_FSL5, AGFFileReader.Air, OHARA.S_LAH66, AGFFileReader.Air, missing],
...
function draw_multiHOE(filename::Union{Nothing,AbstractString}=nothing)
    ...
    int1 = HologramInterface(
        ...
        0.55, 100.0, AGFFileReader.Air, AGFFileReader.Examples_N_BK7, AGFFileReader.Air, AGFFileReader.Air, AGFFileReader.Air, 0.05, false)

...
41-element Array{Any,1}:
 OpticSimCore.GlassCat.AMTIR
 OpticSimCore.GlassCat.ANGSTROMLINK
 OpticSimCore.GlassCat.APEL
 OpticSimCore.GlassCat.ARCHER
 OpticSimCore.GlassCat.ARTON
 OpticSimCore.GlassCat.AUER_LIGHTING
 OpticSimCore.GlassCat.BIREFRINGENT
 ⋮
```
"""
...
6-element Array{Pair{Module,Array{Any,1}},1}:
 OpticSimCore.GlassCat.CARGILLE => ["OG0607", "OG0608", "OG081160"]
     OpticSimCore.GlassCat.HOYA => ["BAC4", "BACD11"  …  "TAFD65"]
    OpticSimCore.GlassCat.NIKON => ["BAF10", "BAF11"  …  "_7054"]
    OpticSimCore.GlassCat.OHARA => ["L_BAL35", "L_BAL35P"  …  "S_TIM8"]
   OpticSimCore.GlassCat.SCHOTT => ["AF32ECO", "BAFN6"  …  "SFL6"]
   OpticSimCore.GlassCat.SUMITA => ["BAF1", "BAF10"  …  "ZNSF8"]
```
"""

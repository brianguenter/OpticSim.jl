...
mutable struct Defs
    ...
    width::Int64
    html::String        # work area to accumulate html syntax in order to save cell space (ouput at the end of a single cell)
end
Defs() = Defs("?Authors?")
...
This behavior will prevent users from updating the original sample notebook. 
"""

...
function ParaxialLensRect(focaldistance::T, halfsizeu::T, halfsizev::T, surfacenormal::AbstractArray{T,1}, centrepoint::AbstractArray{T,1}; rotationvec::AbstractArray{T,1}=SVector{3,T}(0.0, 1.0, 0.0), outsidematerial::AGFFileReader.AbstractGlass=AGFFileReader.Air, decenteruv::Tuple{T,T}=(zero(T), zero(T))) where {T<:Real}
...
function ParaxialLensRect(focaldistance::T, halfsizeu::T, halfsizev::T, surfacenormal::SVector{3,T}, centrepoint::SVector{3,T}; rotationvec::SVector{3,T}=SVector{3,T}(0.0, 1.0, 0.0), outsidematerial::AGFFileReader.AbstractGlass=AGFFileReader.Air, decenteruv::Tuple{T,T}=(zero(T), zero(T))) where {T<:Real}
...
function ParaxialLensHex(focaldistance::T, side_length::T, surfacenormal::AbstractArray{T,1}, centrepoint::AbstractArray{T,1}; rotationvec::AbstractArray{T,1}=SVector{3,T}(0.0, 1.0, 0.0), outsidematerial::AGFFileReader.AbstractGlass=AGFFileReader.Air, decenteruv::Tuple{T,T}=(zero(T), zero(T))) where {T<:Real}
    @assert length(surfacenormal) == 3 && length(centrepoint) == 3
...
function ParaxialLensHex(focaldistance::T, side_length::T, surfacenormal::SVector{3,T}, centrepoint::SVector{3,T}; rotationvec::SVector{3,T}=SVector{3,T}(0.0, 1.0, 0.0), outsidematerial::AGFFileReader.AbstractGlass=AGFFileReader.Air, decenteruv::Tuple{T,T}=(zero(T), zero(T))) where {T<:Real}
...
function ParaxialLensConvexPoly(focallength::T, convpoly::ConvexPolygon{N,T}, local_center_point::SVector{2,T}; outsidematerial::AGFFileReader.AbstractGlass=AGFFileReader.Air) where {N,T<:Real}
...
function ParaxialLensEllipse(focaldistance::T, halfsizeu::T, halfsizev::T, surfacenormal::AbstractArray{T,1}, centrepoint::AbstractArray{T,1}; rotationvec::AbstractArray{T,1}=SVector{3,T}(0.0, 1.0, 0.0), outsidematerial::AGFFileReader.AbstractGlass=AGFFileReader.Air, decenteruv::Tuple{T,T}=(zero(T), zero(T))) where {T<:Real}
    @assert length(surfacenormal) == 3 && length(centrepoint) == 3
...
function ParaxialLensEllipse(focaldistance::T, halfsizeu::T, halfsizev::T, surfacenormal::SVector{3,T}, centrepoint::SVector{3,T}; rotationvec::SVector{3,T}=SVector{3,T}(0.0, 1.0, 0.0), outsidematerial::AGFFileReader.AbstractGlass=AGFFileReader.Air, decenteruv::Tuple{T,T}=(zero(T), zero(T))) where {T<:Real}

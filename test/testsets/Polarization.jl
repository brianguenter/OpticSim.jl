@testitem "Fresnel Amplitude" begin
...
@testitem "Fresnel Intensity" begin
    # Normal incidence, nᵢ = nₜ
    nᵢ = 1.5
    nₜ = 1.5
    cosθᵢ = 1.0
...
@testitem "Fresnel Amplitude with Complex Index" begin
...
@testitem "Fresnel Intensity with Complex Index" begin
    nᵢ = 1.0
    nₜ = 1.5 + 0.1im
    cosθᵢ = 1.0
